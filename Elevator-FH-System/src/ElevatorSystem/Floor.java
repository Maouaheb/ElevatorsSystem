package ElevatorSystem; import java.util.ArrayList; import java.util.List; public class Floor {
	...
	public void setHandicapCall(boolean handicapCall) {
		System.out.println("Button handicap call is pressed in floor"+thisFloorID);
