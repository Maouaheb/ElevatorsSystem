import ElevatorSystem.Elevator; import ElevatorSystem.Environment; import ElevatorSystem.EvilPerson; import ElevatorSystem.Person; import java.util.List;
import java.util.Random;
import java.util.ArrayList;
import java.util.Arrays;
import java.lang.Throwable; public  class PL_Interface_impl implements PL_Interface {
	...
	/*@ 
	 ...
	 private void  test__wrappee__Base  (int specification, int variation) {
		 SpecificationsStrategy spec=null;
		if (variation==-1) {
